...
public class Class : MonoBehaviour {
    ...
    // Game Classes
    // Note: Only the TAFE level needs a sprite, as it is not incrementally loaded
    public static ClassManager Accounting = new ClassManager(
        NAME: "Accounting",
        ACRO: "ACC",
        TAFE: new BaseClass(accSprite, 1f, 0, 500, 25),
        DIPL: new BaseClass(null, 3f, 1, 100, 50),
        BACH: new BaseClass(null, 5f, 2, 150, 100),
        HONR: new BaseClass(null, 6f, 3, 150, 150),
        PHD: new BaseClass(null, 8f, 4, 350, 200));

    public static ClassManager ComputerScience = new ClassManager(
        NAME: "Computer Science",
        ACRO: "CS",
        TAFE: new BaseClass(csSprite, 1f, 0, 500, 25),
        DIPL: new BaseClass(null, 2f, 1, 100, 50),
        BACH: new BaseClass(null, 4f, 2, 200, 100),
        HONR: new BaseClass(null, 8f, 3, 100, 150),
        PHD: new BaseClass(null, 13f, 4, 600, 200));

    public static ClassManager Medicine = new ClassManager(
        NAME: "Medicine",
        ACRO: "MED",
        TAFE: new BaseClass(medSprite, 1f, 0, 500, 25),
        DIPL: new BaseClass(null, 1f, 1, 300, 50),
        BACH: new BaseClass(null, 4f, 2, 1000, 100),
        HONR: new BaseClass(null, 11f, 3, 200, 150),
        PHD: new BaseClass(null, 26f, 4, 2000, 200));

    public static ClassManager Teaching = new ClassManager(
        NAME: "Teaching",
        ACRO: "ART",
        TAFE: new BaseClass(teaSprite, 1f, 0, 500, 25),
        DIPL: new BaseClass(null, 4f, 1, 50, 50),
        BACH: new BaseClass(null, 5f, 2, 100, 100),
        HONR: new BaseClass(null, 5f, 3, 100, 150),
        PHD: new BaseClass(null, 5f, 4, 250, 200));
}
